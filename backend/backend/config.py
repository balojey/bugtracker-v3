...
class Settings(BaseSettings):
    ...
    database_url: str = "mongodb+srv://balotech514:1ZJFZclyZBsvSOa5@cluster1.ugtl2kv.mongodb.net/?retryWrites=true&w=majority"  # getenv("DATABASE_URL")
    ...
    google_client_secret: str = (
        "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"  # getenv("GOOGLE_CLIENT_SECRET")
    )
